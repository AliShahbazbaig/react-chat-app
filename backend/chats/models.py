...
class Conversation(models.Model):
    ...
    user1 = models.ForeignKey(User, on_delete=models.CASCADE, null=True,related_name="conversations_as_user1")
    user2 = models.ForeignKey(User, on_delete=models.CASCADE, null=True,related_name="conversations_as_user2")
    ...
    class Meta:
        unique_together = ('user1', 'user2')  # Ensures only one conversation between two users
        constraints = [
        models.UniqueConstraint(fields=['name'], condition=models.Q(conversation_type='group'), name='unique_group_name')
        ]
        indexes = [
    ...
    def save(self, *args, **kwargs):
        # Ensure consistent ordering for direct messages
    ...
    def get_or_create_direct(cls, user_a, user_b):
        ...
        # Only direct conversations use user1/user2
